...
const Navbar: React.FC = () => {
  ...
  return (
    <>
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <div className="flex justify-start">
              ...
              <Button variant="ghost" className="px-1" onClick={toggleMobileMenu}>
                <Menu size={24} />
              </Button>
            </div>
          </div>
          ...
          <div className="flex-grow mx-4 hidden lg:flex flex-col lg:flex-row items-center justify-center space-x-6">
            ...
            <Link to="/" className="relative group text-gray-700 hover:text-blue-500 font-black ml-2">
              ...
              <Link to="/contact" className="relative group text-gray-700 hover:text-blue-500 font-black">
                تماس با ما
                <span className="absolute left-0 bottom-0 w-0 h-0.5 bg-blue-500 transition-all duration-300 group-hover:w-full"></span>
              </Link>
      ...
      <MobileMenuSheet open={isMobileMenuOpen} onOpenChange={setIsMobileMenuOpen} />
