        ...
        <div className="md:w-2/3 p-8">
          <Tabs defaultValue="borrowed">
            <TabsList className="w-full flex justify-end mb-4 bg-gray-100 p-1 rounded-lg">
              <TabsTrigger value="borrowed" className="px-4 py-2">کتاب‌های امانت گرفته شده</TabsTrigger>
              <TabsTrigger value="requested" className="px-4 py-2">کتاب‌های درخواست شده</TabsTrigger>
            </TabsList>
